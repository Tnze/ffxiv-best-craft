...
pub struct Model {
    ...
    pub collectables_metadata_key: i32,
    #[sea_orm(column_name = "CollectablesMetadata")]
    pub collectables_metadata: i32,
}
...
pub enum Relation {
    ...
    RecipeLevelTables,
    #[sea_orm(
        belongs_to = "super::collectables_shop_refine::Entity",
        from = "Column::CollectablesMetadata",
        to = "super::collectables_shop_refine::Column::Id",
        on_condition = r#"Column::CollectablesMetadataKey.eq(1)"#,
        on_update = "NoAction",
        on_delete = "Cascade"
    )]
...
impl Related<super::collectables_shop_refine::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::CollectablesShopRefine.def()
    }
}
